...
const ConfirmBookCategoryDeletion = ({ categoryId }) => {
    ...
    return (
        <div className="flex flex-col bg-white p-2 rounded-xl z-50 md:w-1/3 w-4/5 relative py-4">
            ...
            <div className="flex flex-row w-full justify-end items-center mt-2">
                <Button onClick={() => hideModal()} className="mr-1" buttonStyle="tertiary" buttonSize="md" >Cancel</Button>
                <Button onClick={confirmDelete} buttonStyle="custom" buttonSize="md" className="ml-1 bg-red-600 hover:bg-red-800 text-white">
